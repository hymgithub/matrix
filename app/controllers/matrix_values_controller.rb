...
=end
  ...
  def destroy
    @matrix_value = MatrixValue.find(params[:value_id])
    ...
    respond_to do |format|
	format.html { redirect_to :controller=>"matrix_params", :action=>'index',:matrix_config_id=>@matrix_param.matrix_config_id }
