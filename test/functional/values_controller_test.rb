...
class ValuesControllerTest < ActionController::TestCase
  ...
  test "should create value" do
    assert_difference('Value.count') do
      post :create, value: { is_default: @value.is_default, parameter_id: @value.parameter_id, status: @value.status, value: @value.value, weight: @value.weight }
    end
  ...
  test "should update value" do
    put :update, id: @value, value: { is_default: @value.is_default, parameter_id: @value.parameter_id, status: @value.status, value: @value.value, weight: @value.weight }
    assert_redirected_to value_path(assigns(:value))
  end
