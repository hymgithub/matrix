...
class ParametersControllerTest < ActionController::TestCase
  ...
  test "should create parameter" do
    assert_difference('Parameter.count') do
      post :create, parameter: { is_default: @parameter.is_default, name: @parameter.name, status: @parameter.status, weight: @parameter.weight }
    end
  ...
  test "should update parameter" do
    put :update, id: @parameter, parameter: { is_default: @parameter.is_default, name: @parameter.name, status: @parameter.status, weight: @parameter.weight }
    assert_redirected_to parameter_path(assigns(:parameter))
  end
